...
of Nwalls from left to right. Mario is currently
...
of the Nwalls from left to right. Each height is a positive integer not exceeding 10.
Output
...
let saltoSopra:number=0
let saltoSotto:number=0
...
console.log(saltoSopra , saltoSotto)
